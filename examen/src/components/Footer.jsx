            ...
            <div className="container">
                <div className="-mx-4 flex flex-wrap">
                    ...
                    <LinkGroup header="Resources">
                        <NavLink to="/" label="SaaS Development" />
                        <NavLink to="/" label="Our Products" />
                        <NavLink to="/" label="User Flow" />
                        <NavLink to="/" label="User Strategy" />
                    </LinkGroup>
                    <LinkGroup header="Company">
                        <NavLink to="/" label="About TailGrids" />
                        <NavLink to="/" label="Contact & Support" />
                        <NavLink to="/" label="Success History" />
                        <NavLink to="/" label="Setting & Privacy" />
                    </LinkGroup>
                    <LinkGroup header="Quick Links">
                        <NavLink to="/" label="Premium Support" />
                        <NavLink to="/" label="Our Services" />
                        <NavLink to="/" label="Know Our Team" />
                        <NavLink to="/" label="Download App" />
                    </LinkGroup>
